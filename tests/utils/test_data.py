...
class TestDistributeAnisotropicHyperparameters:
    ...
    def test_scalar_per_group(self) -> None:
...
class TestResolveBoundsShape:
    ...
    def test_single_bound_expanded_to_n_dims(self) -> None:
        bounds = [(1.0, 10.0)]
    ...
    def test_single_bound_single_dim_unchanged(self) -> None:
        bounds = [(1.0, 10.0)]
...
class TestStandardizeInputData:
    ...
    def test_constant_feature_std_set_to_one(self) -> None:
...
class TestStandardizeTargetData:
    ...
    def test_constant_target_std_set_to_one(self) -> None:
        arr = np.full(10, math.pi)
